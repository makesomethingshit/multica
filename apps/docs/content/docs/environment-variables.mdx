...
| `MULTICA_WORKSPACES_ROOT` | `~/multica_workspaces` for an installation that already has one, otherwise `~/multica_workspaces_<work-state key>` | Root directory for run working directories |
