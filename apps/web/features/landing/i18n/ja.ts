...
export function createJaDict(
  ...
  return {
    ...
    privacy: {
      ...
      intro: [
        "このプライバシーポリシーは、Index Labs (Hong Kong) Limited(以下「Multica」または「当社」)が、multica.ai へのアクセス、当社へのお問い合わせ、またはホスティングサービスである Multica Cloud(Web、デスクトップ、モバイルアプリを含む)のご利用に際して、個人情報をどのように収集、利用、共有するかを説明するものです。",
      ...
      sections: [
        {
          ...
          bullets: [
            ...
            "お客様が作成するコンテンツ: ワークスペース、タスク、コメント、チャットメッセージ、添付ファイル、エージェントへの指示など、お客様またはお客様のエージェントが Multica Cloud に入力するすべてのもの。",
        ...
        },
        {
          heading: "情報の利用目的",
          bullets: [
            "Multica Cloud の提供、運用、保護(サインイン、ワークスペースの同期、通知や招待の配信など)。",
            "営業へのお問い合わせやサポートへの対応。",
        ...
        },
        {
          heading: "法的根拠",
          paragraphs: [
            "法令で処理の法的根拠の明示が求められる地域では、次の根拠に基づいて個人情報を処理します。Multica Cloud を提供するためのお客様との契約の履行、Multica の安全確保・サポート・改善およびお問い合わせへの対応に関する当社の正当な利益、マーケティング情報の受信に関するお客様の同意、そして当社の法的義務の遵守です。",
          ],
        },
        {
          heading: "AI 機能",
          paragraphs: [
            ...
            "Multica Cloud の一部の機能(チャットのタイトル生成や、次のアクションの提案など)では、結果を生成するために、最初のチャットメッセージや直近のいくつかのメッセージを、当社が選んだ外部の大規模言語モデルプロバイダーに送信します。Multica がお客様のコンテンツを AI モデルの学習に使うことはありません。",
          ],
        },
        {
          heading: "Cookie と分析",
        ...
        },
        {
          heading: "情報の保存場所",
          paragraphs: [
            "Multica Cloud は Amazon Web Services と Vercel 上でホストされています。当社およびサービス提供者は、米国その他の国や地域でお客様の情報を処理することがあります。どこで処理される場合も、本ポリシーに従って情報を保護します。",
          ],
        },
        {
          heading: "保存期間",
